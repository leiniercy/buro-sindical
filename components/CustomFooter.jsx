...
return(
    ...
    <div className="relative flex flex-column gap-1 justify-center justify-content-center align-items-center w-full h-full">
        <div class="w-20rem">
            <h1 className='w-full text-center'>Síguenos :</h1>
        </div></div>
    <footer class="w-full text-gray-500 bg-gray-200 body-font">
        <div class="container flex flex-col flex-wrap px-5 py-30 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
           <div className='relative flex flex-column gap-1 justify-center justify-content-center align-items-center w-full h-full'>
    <div className="relative flex flex-column gap-1 justify-center justify-content-center align-items-center w-full h-full">
        <div class="w-18rem">
                <img alt="logo" src="/assets/image/logo-uci.png" height="100" className="mr-4"></img>
                </div>
                </div>
                <div className='col-12 flex flex-row flex-wrap gap-3'></div>
                <div class="mt-4">
                    <span class="inline-flex justify-left mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-700">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                class="w-2 h-2" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <div className='col-2 flex flex-row flex-wrap gap-3'></div>
                        <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-900">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                class="w-2 h-2" viewBox="0 0 24 24">
                                <path
                        ...
                        <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" class="w-2 h-2" viewBox="0 0 24 24">
                        ...
                        <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
                            <svg fill="currentColor" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="0" class="w-2 h-2" viewBox="0 0 24 24">
                                <path stroke="none"
            ...
            <div className='col-12 flex flex-row flex-wrap gap-3'>
            <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                ...
                <div className='col-8 flex flex-row flex-wrap gap-3'>
                <div class="w-full px-4 lg:w-2/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        ...
                        <li class="mt-3">
                            <a class="text-gray-500 cursor-pointer hover:text-gray-900">Atualizaciones</a>
                        </li>
                    </nav>
                </div></div>
                <div className='col-6 flex flex-row flex-wrap gap-3'></div>
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        <li class="mt-3">
                            <a class="text-gray-500 cursor-pointer hover:text-gray-900">Ariel</a>
                        </li>
                        <li class="mt-3">
                            <a class="text-gray-500 cursor-pointer hover:text-gray-900">Alarcon Jorge</a>
                        </li>
                        <li class="mt-3">
                            <a class="text-gray-500 cursor-pointer hover:text-gray-900">+5359806002</a>
                        </li>
                    </nav>
                </div>
            </div>
